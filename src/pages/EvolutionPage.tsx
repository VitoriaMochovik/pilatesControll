...
import { Patient, CreateEvolutionInput } from '../types';
import { evolutionsService } from '../services/supabase';
...
export const EvolutionPage: React.FC<EvolutionPageProps> = ({
  ...
  const handleSubmit = async (date: CreateEvolutionInput) => {
    try {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-teal-100">
      ...
      <div className="bg-gradient-to-r from-teal-600 to-teal-700 text-white p-6 shadow-lg">
        ...
        <div>
          <h1 className="text-3xl font-bold">Registrar Evolução Clínica</h1>
